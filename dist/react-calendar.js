...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Week = function (_React$Component) {
	  ...
	  function Week() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Week.__proto__ || Object.getPrototypeOf(Week)).call.apply(_ref, [this].concat(args))), _this), _this.getModsFromProps = function (props) {
	      var mods = props.mods,
	          date = props.date;
	  ...
	  _createClass(Week, [{
	    ...
	    value: function shouldComponentUpdate(nextProps) {
	      var thisWeekModifiers = this.getModsFromProps(this.props);
	      var nextWeekModifiers = this.getModsFromProps(nextProps);

	      return this.props.numberOfEventsByDate !== nextProps.numberOfEventsByDate || nextWeekModifiers.clsMods.length !== 0 || nextWeekModifiers.clsMods.length !== thisWeekModifiers.clsMods.length;
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          (0, _dateUtils.daysOfWeek)(date).map(function (date, i) {
	            var outside = void 0;

	            if (_this2.props.edges) {
	              outside = Boolean(_this2.props.edges.find(function (edge, j) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Day = function (_React$Component) {
	    ...
	    function Day() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Day.__proto__ || Object.getPrototypeOf(Day)).call.apply(_ref, [this].concat(args))), _this), _this.getModsFromProps = function (props) {
	            var date = props.date,
	                mods = props.mods,
	    ...
	    _createClass(Day, [{
	        ...
	        value: function shouldComponentUpdate(nextProps) {
	            ...
	            var currentModifiers = this.getModsFromProps(this.props);
	            var nextModifiers = this.getModsFromProps(nextProps);

	            var currentClsDay = (0, _classnames2.default)(clsPrefix, { 'rc-Day--outside': outside }, currentModifiers.clsMods);
	            var currentEventsByDay = this.props.numberOfEventsByDate[date.format(this.props.fullYearMonthDayFormat)];
	        ...
	        value: function render() {
	            ...
	            var _props2 = this.props,
	                date = _props2.date,
	                outside = _props2.outside;

	            var modifiers = this.getModsFromProps(this.props);

	            var clsDay = (0, _classnames2.default)(clsPrefix, { 'rc-Day--outside': outside }, modifiers.clsMods);
	            var eventsByDay = this.props.numberOfEventsByDate[date.format(this.props.fullYearMonthDayFormat)];

	            return _react2.default.createElement(
	                'div',
	                _extends({ className: clsDay }, modifiers.events),
	                _react2.default.createElement(
	                    'div',
	                ...
	                _react2.default.createElement(
	                    ...
	                    eventsByDay > 0 && !outside ? eventsByDay === 1 ? this.props.annotations[0] : this.props.annotations[1] || '' : ''
	                )
	            );
	        }
	    }]);
